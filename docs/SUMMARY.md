...
- [Retrieving knowledge](retrieval.md)

# Knowledge workflows

- [Page protocols](protocols.md)
- [Rules and findings](rules-and-findings.md)
- [Transactional publishing](publishing.md)
- [Audits and CI](audit-and-ci.md)
...
- [Agent and MCP integration](agent-coordination.md)

# Operations

- [Configuration](configuration.md)
- [Storage and concurrency](storage-and-concurrency.md)
- [Build and self-host these docs](self-hosting.md)
